...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(
    sql`CREATE INDEX \`users__status_idx\` ON \`users\` (\`_status\`);`
  );
  await db.run(
  ...
  `);
  await db.run(
    sql`CREATE INDEX \`_users_v_parent_idx\` ON \`_users_v\` (\`parent_id\`);`
  );
  await db.run(
  ...
  await db.run(
    sql`CREATE INDEX \`_users_v_created_at_idx\` ON \`_users_v\` (\`created_at\`);`
  );
  await db.run(
    sql`CREATE INDEX \`_users_v_updated_at_idx\` ON \`_users_v\` (\`updated_at\`);`
  );
  await db.run(
    sql`CREATE INDEX \`_users_v_latest_idx\` ON \`_users_v\` (\`latest\`);`
  );
  ...
  `);
  await db.run(
    sql`CREATE INDEX \`pages_blocks_copy_order_idx\` ON \`pages_blocks_copy\` (\`_order\`);`
  );
  await db.run(
    sql`CREATE INDEX \`pages_blocks_copy_parent_id_idx\` ON \`pages_blocks_copy\` (\`_parent_id\`);`
  );
  await db.run(
    sql`CREATE INDEX \`pages_blocks_copy_path_idx\` ON \`pages_blocks_copy\` (\`_path\`);`
  );
  ...
  await db.run(
    sql`CREATE INDEX \`pages__abvariantof_idx\` ON \`pages\` (\`_abvariantof_id\`);`
  );
  await db.run(
  ...
  `);
  await db.run(
    sql`CREATE INDEX \`_pages_v_blocks_copy_order_idx\` ON \`_pages_v_blocks_copy\` (\`_order\`);`
  );
  await db.run(
    sql`CREATE INDEX \`_pages_v_blocks_copy_parent_id_idx\` ON \`_pages_v_blocks_copy\` (\`_parent_id\`);`
  );
  await db.run(
    sql`CREATE INDEX \`_pages_v_blocks_copy_path_idx\` ON \`_pages_v_blocks_copy\` (\`_path\`);`
  );
  ...
  await db.run(
    sql`CREATE INDEX \`_pages_v_version_version__abvariantof_idx\` ON \`_pages_v\` (\`version__abvariantof_id\`);`
  );
  await db.run(
  ...
  `);
  await db.run(
    sql`CREATE INDEX \`presets_preview_idx\` ON \`presets\` (\`preview_id\`);`
  );
  await db.run(
    sql`CREATE INDEX \`presets_updated_at_idx\` ON \`presets\` (\`updated_at\`);`
  );
  await db.run(
    sql`CREATE INDEX \`presets_created_at_idx\` ON \`presets\` (\`created_at\`);`
  );
  ...
  `);
  await db.run(
    sql`CREATE INDEX \`comments_mentions_order_idx\` ON \`comments_mentions\` (\`_order\`);`
  );
  await db.run(
    sql`CREATE INDEX \`comments_mentions_parent_id_idx\` ON \`comments_mentions\` (\`_parent_id\`);`
  );
  await db.run(
    sql`CREATE INDEX \`comments_mentions_user_idx\` ON \`comments_mentions\` (\`user_id\`);`
  );
  ...
  `);
  await db.run(
    sql`CREATE INDEX \`comments_document_id_idx\` ON \`comments\` (\`document_id\`);`
  );
  await db.run(
    sql`CREATE INDEX \`comments_collection_slug_idx\` ON \`comments\` (\`collection_slug\`);`
  );
  await db.run(
    sql`CREATE INDEX \`comments_global_slug_idx\` ON \`comments\` (\`global_slug\`);`
  );
  await db.run(
    sql`CREATE INDEX \`comments_field_path_idx\` ON \`comments\` (\`field_path\`);`
  );
  await db.run(
    sql`CREATE INDEX \`comments_locale_idx\` ON \`comments\` (\`locale\`);`
  );
  await db.run(
    sql`CREATE INDEX \`comments_author_idx\` ON \`comments\` (\`author_id\`);`
  );
  await db.run(
    sql`CREATE INDEX \`comments_resolved_by_idx\` ON \`comments\` (\`resolved_by_id\`);`
  );
  await db.run(

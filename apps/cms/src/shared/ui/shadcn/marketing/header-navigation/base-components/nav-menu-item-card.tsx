    ...
    >
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-col gap-1">
          <h4 className="line-clamp-2 overflow-hidden text-sm font-semibold text-ellipsis text-primary">
            {props.title}
          </h4>
...
export const ImageCardVertical = (props: ImageCardProps) => {
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-3">
        <div className="flex flex-col gap-1">
          <h4 className="line-clamp-1 overflow-hidden text-sm font-semibold text-ellipsis text-primary">
            {props.title}
          </h4>
          <p className="line-clamp-2 text-sm text-ellipsis text-tertiary">{props.subtitle}</p>
        </div>
  ...
  return (
    ...
    >
      <img
        alt={props.title}
        src={props.imgSrc}
        className="aspect-video w-60 shrink-0 rounded-md object-cover"
      />

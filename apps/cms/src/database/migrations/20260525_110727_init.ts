...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_header_nav_items_link_type" AS ENUM('reference', 'custom', 'customPage');
  ...
  CREATE TYPE "public"."enum__header_v_version_nav_items_link_type" AS ENUM('reference', 'custom', 'customPage');
  ...
  CREATE TABLE "_page_v" (
  	...
  	"version__abvariantpercentages" jsonb,
  ...
  CREATE TABLE "header_nav_items" (
  	...
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_custom_page" "enum_header_nav_items_link_custom_page",
  	"link_label" varchar
  );
  ...
  CREATE TABLE "_header_v_version_nav_items" (
  	...
  	"link_new_tab" boolean,
  	"link_url" varchar,
  	"link_custom_page" "enum__header_v_version_nav_items_link_custom_page",
  	"link_label" varchar,
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"payload_mcp_tool_get_document" boolean DEFAULT true,
  	"payload_mcp_tool_get_all_documents" boolean DEFAULT true,
  	"payload_mcp_tool_get_global_document" boolean DEFAULT true,
  	"payload_mcp_tool_get_field" boolean DEFAULT true,
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"header_id" integer,
  	"footer_id" integer,
  	"document_embeddings_id" integer,
  ...
  CREATE TABLE "site_settings_locales" (
  	...
  	"blog_read_more_label" varchar,
  	"blog_related_posts_label" varchar,
  ...
  CREATE TABLE "_site_settings_v_locales" (
  	...
  	"version_blog_read_more_label" varchar,
  	"version_blog_related_posts_label" varchar,

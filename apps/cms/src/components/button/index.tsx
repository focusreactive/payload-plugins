    ...
    variants: {
      ...
      variant: {
        ...
        [ButtonVariant.Primary]:
          "rounded-pill font-medium bg-secondary text-secondary-foreground hover:bg-secondary-hover",
        [ButtonVariant.Accent]:
          "rounded-pill font-medium bg-accent text-accent-foreground hover:bg-accent-hover",
        [ButtonVariant.Secondary]:
          "rounded-pill font-medium border border-foreground text-foreground hover:bg-foreground hover:text-background",
        [ButtonVariant.Badge]:
          "rounded-pill border border-foreground px-3 py-1.5 text-eyebrow text-foreground",
        [ButtonVariant.Ghost]:
          "rounded-pill font-medium bg-surface text-foreground border border-border-strong hover:border-foreground",

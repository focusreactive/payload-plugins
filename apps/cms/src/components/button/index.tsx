...
export const buttonVariants = cva(
  // No whitespace-nowrap: CTA labels are editor-entered copy with no length limit, and a long one
  // must wrap inside the button rather than run off the edge of a narrow viewport.
  "inline-flex items-center justify-center gap-2 text-center leading-none transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    defaultVariants: {

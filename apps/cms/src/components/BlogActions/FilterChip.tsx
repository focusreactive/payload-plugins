...
export function FilterChip({ href, label, isActive }: FilterChipProps) {
  ...
  return (
    <Link
      ...
      className={cn(
        "rounded-pill border px-4 py-[9px] text-[0.72rem] uppercase leading-none tracking-[0.1em] transition-[color,background-color,border-color,opacity] motion-reduce:transition-none",
        isActive

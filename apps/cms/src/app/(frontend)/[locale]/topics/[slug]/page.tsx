 ...
 * so the route existing is what keeps those links alive.
 *
 * Route placement note: this sits under [locale] because proxy.ts rewrites every top-level path
 * except api|admin|_next|_vercel into the locale catch-all. A route at /topics/[slug] outside
...
export default async function TopicPage({ params }: PageProps) {
  ...
  return (
    <main style={{ margin: "0 auto", maxWidth: 760, padding: "40px 20px 120px" }}>

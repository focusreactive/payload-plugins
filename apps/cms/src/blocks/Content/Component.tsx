...
export const ContentBlockComponent: React.FC<ContentBlockProps> = ({ heading, layout, content, image, section, id }) => (
  <SectionContainer sectionData={{ ...section, id }}>
    ...
    <div className={variants({ layout })}>
      <Media resource={image} fill className="relative mb-6 sm:mb-8 lg:mb-0 w-full lg:w-1/2 h-48 sm:h-64 md:h-80 lg:h-96 rounded-lg shadow-lg overflow-hidden" imgClassName="object-cover" />
      {content && (

  ...
  return (
    <Dialog.Root open={open} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        <Dialog.Overlay
          className={cn(
            "fixed inset-0 z-[90] bg-[rgba(6,14,13,0.5)] backdrop-blur-[3px]",
        ...
        <Dialog.Content
          ...
          className={cn(
            "fixed left-1/2 top-1/2 z-[95] w-[min(560px,92vw)] -translate-x-1/2 -translate-y-1/2",
        ...
        >
          ...
          <form role="search" onSubmit={onSubmit} className="flex items-center gap-2.5 rounded-pill border border-border-strong bg-surface pl-[18px] pr-2 shadow-[0_30px_70px_-20px_rgba(6,14,13,0.6)]">
            ...
            <input
              ...
              className="min-w-0 flex-1 bg-transparent py-[15px] text-[1.05rem] text-foreground outline-none placeholder:text-muted-foreground"
            />

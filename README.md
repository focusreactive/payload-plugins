...
| [`@focus-reactive/payload-plugin-schedule-publication`](./packages/payload-plugin-schedule-publication) | [![npm](https://img.shields.io/npm/v/@focus-reactive/payload-plugin-schedule-publication)](https://www.npmjs.com/package/@focus-reactive/payload-plugin-schedule-publication) | Schedule publication plugin — schedule documents to publish at a future date |

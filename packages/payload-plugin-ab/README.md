...
`ExperimentTracker` is a Client Component. Props:

| Prop                | Type     | Required | Description                                                              |
| ------------------- | -------- | -------- | ------------------------------------------------------------------------ |
| `experimentId`      | `string` | Yes      | Manifest key (URL path, e.g. `/en/about`)                                |
| `variantCookieName` | `string` | No       | Override the cookie name for variant bucket (use `resolveAbCookieNames`) |
| `visitorCookieName` | `string` | No       | Override the cookie name for visitor ID (use `resolveAbCookieNames`)     |
...
| Import path                                                 | Exports                                                                                                                                                                                             |
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `@focus-reactive/payload-plugin-ab`                         | `abTestingPlugin`, `AbTestingPluginConfig`, `CollectionABConfig`, `StorageAdapter`, `AbCookieConfig`, `resolveAbCookieNames`, `ResolvedAbCookieNames`, `AB_EXPERIMENTS_SLUG`, `AB_DIMENSION_PARAMS` |
...
| `@focus-reactive/payload-plugin-ab/analytics`               | `ExperimentTracker`, `ExperimentTrackerProps`, `AbCookieConfig`, `resolveAbCookieNames`, `ResolvedAbCookieNames`                                                                                    |
| `@focus-reactive/payload-plugin-ab/analytics/client`        | `ExperimentTracker`, `ExperimentTrackerProps`, `AbCookieConfig`, `resolveAbCookieNames`, `ResolvedAbCookieNames`                                                                                    |

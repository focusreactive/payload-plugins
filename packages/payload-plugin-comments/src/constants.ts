export const DEFAULT_COLLECTION_SLUG = "comments";
export const COMMENTS_DRAWER_BASE_SLUG = "comments-panel";

export const DELETE_MODAL_SLUG_PREFIX = "comments-delete-";
...
export const COMMENT_READS_COLLECTION_SLUG = "comment-reads";
export const UNREAD_COUNT_REFETCH_INTERVAL = 30000;

...
const badgeVariants = cva("absolute -top-1 -right-1 min-w-[14px] h-[14px] px-[3px] rounded-full text-white text-[9px] font-semibold leading-[14px] text-center pointer-events-none select-none", {
  variants: {
    status: {
      good: "bg-seo-good",
      warn: "bg-seo-warn",

      ...
      >
        <div className="px-5 py-4 border-b border-[var(--theme-border-color)] flex flex-col gap-1">
          <div className="flex items-center gap-2">
            <span className="text-[15px] font-semibold text-[var(--theme-elevation-1000)] font-[family-name:var(--font-mono)]">{shortId(row.sessionId)}</span>
        ...
        <div className="grid grid-cols-4 px-5 py-3.5 border-b border-[var(--theme-border-color)] bg-[var(--theme-elevation-50)]">
          <div>
            <div className="text-[10px] tracking-wider uppercase text-[var(--theme-elevation-500)] font-semibold">Events</div>

            <div className="text-base font-semibold text-[var(--theme-elevation-1000)] tabular-nums mt-0.5">{row.eventCount}</div>
          </div>

          <div>
            <div className="text-[10px] tracking-wider uppercase text-[var(--theme-elevation-500)] font-semibold">Device</div>
          ...
          <div>
            <div className="text-[10px] tracking-wider uppercase text-[var(--theme-elevation-500)] font-semibold">Country</div>

            <div className="text-base font-semibold text-[var(--theme-elevation-1000)] mt-0.5">{row.country.join(", ")}</div>
          </div>

          <div>
            <div className="text-[10px] tracking-wider uppercase text-[var(--theme-elevation-500)] font-semibold">Lead action</div>

            <div className="text-[13px] mt-0.5">{row.hadLeadAction ? <span className="text-[var(--theme-success-700)]">Yes</span> : <span className="text-[var(--theme-elevation-500)]">—</span>}</div>
          </div>
        </div>

        <div className="flex-1 overflow-auto p-5">
          <div className="text-[11px] font-semibold tracking-wider uppercase text-[var(--theme-elevation-500)] mb-3">Event timeline</div>
          ...
          {fullSetupRequired ? (
            ...
            <div className="text-[var(--theme-elevation-500)] py-5 text-center">No events recorded for this session.</div>
          )}
        </div>
      </div>
    </>

...
export const indPillVariants = cva("inline-flex items-center rounded-full border px-[7px] py-px text-[10px] font-semibold tracking-[0.01em]", {
  variants: {
    tone: {
      ...
      neutral: "border-transparent bg-(--theme-elevation-100) text-[var(--theme-elevation-600,var(--theme-elevation-500))]",
    },
  },
  defaultVariants: { tone: "neutral" },
});
...
export const verdictBadgeVariants = cva("inline-flex items-center gap-1 whitespace-nowrap rounded-full px-2 py-[3px] text-[11px] font-medium", {
  variants: {
    verdict: {
      winner: "border border-(--theme-success-100) bg-(--theme-success-50) text-(--theme-success-700) dark:text-(--theme-success-500)",

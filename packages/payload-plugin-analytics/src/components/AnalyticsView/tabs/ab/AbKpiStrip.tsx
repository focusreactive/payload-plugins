    ...
    >
      <div
        className={cn(
          ...
          tone === "warn"
            ? "[&_svg]:text-(--theme-warning-700)"
            : "[&_svg]:text-(--theme-elevation-500)"
        )}
      >
        <Icon size={13} />
        <span>{label}</span>
      ...
      <div
        className={cn(
          ...
          tone === "warn"
            ...
            : tone === "ok"
              ? "text-(--theme-success-700) dark:text-(--theme-success-500)"
  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-3">
      <Card
        ...
        sub={
          winRate
            ? `${winRate.winners}/${winRate.qualified} qualified · ${winRate.notQualified} not yet`
            : undefined
        }
      />
      ...
      <Card
        ...
        label="Variants live"
        value={variantsLive ?? "—"}
        sub="across experiments"
      />

      <Card
        icon={Activity}
        label="Exposed sessions"
        value={exposedSessions ? formatNumber(exposedSessions) : "—"}
      />

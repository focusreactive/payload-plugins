              ...
              <Tooltip
                ...
                content={
                  <>
                    ...
                    <TooltipText>
                      Largest relative lift in lead-conversion rate among the variants versus the control bucket. An
                      arrow appears once the result clears statistical significance — grey with no arrow means not yet
                      significant.
                    </TooltipText>
                  </>
                }>
              ...
              <Tooltip
                ...
                content={
                  <>
                    ...
                    <TooltipText>
                      Chi-square test that the observed traffic split matches the configured split. A mismatch points to
                      a bucketing or tracking bug that invalidates results.
                    </TooltipText>
                    <TooltipLegend>
            ...
            <tr
              ...
              <td>
                <div className="flex flex-col gap-px">
                  ...
                  {row.parentTitle && (
                    <span className="truncate text-[11px] text-(--theme-elevation-500)">{row.parentTitle}</span>
                  )}
                </div>
              </td>

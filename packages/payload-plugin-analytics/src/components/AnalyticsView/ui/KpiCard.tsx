...
export function KpiCard(props: KpiCardProps) {
  const { label, icon: Icon, value, format, prevValue, invertDelta, loading, error, onRetry, missing } = props;
  ...
  return (
    <div className="bg-[var(--theme-elevation-0)] border border-[var(--theme-border-color)] rounded-[var(--style-radius-m)] p-4 flex flex-col gap-2.5 relative">

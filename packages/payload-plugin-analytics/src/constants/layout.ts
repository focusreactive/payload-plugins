...
export const BUILTIN_LEAD_ACTIONS_BLOCK_IDS = ["total-leads-kpi", "conversion-rate-kpi", "avg-time-kpi", "lead-actions-by-type", "per-page-breakdown", "discovery-paths"] as const;

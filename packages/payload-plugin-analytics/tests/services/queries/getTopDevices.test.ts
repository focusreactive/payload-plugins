...
describe("getTopDevices", () => {
  ...
  it("normalises unknown deviceCategory to 'other'", async () => {
    const fixture = {
      rows: [
        {
          dimensionValues: [{ value: "weird-device" }, { value: "Chrome" }, { value: "Linux" }],
  ...
  it("preserves known deviceCategory values verbatim", async () => {
    const fixture = {
      rows: [
        {
          dimensionValues: [{ value: "desktop" }, { value: "Chrome" }, { value: "Linux" }],
          metricValues: [{ value: "10" }, { value: "8" }],
        },
        {
          dimensionValues: [{ value: "mobile" }, { value: "Safari" }, { value: "iOS" }],
          metricValues: [{ value: "20" }, { value: "15" }],
        },
        {
          dimensionValues: [{ value: "tablet" }, { value: "Safari" }, { value: "iPadOS" }],

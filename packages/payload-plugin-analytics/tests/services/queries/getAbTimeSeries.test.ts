...
describe("getAbTimeSeries", () => {
  it("builds control-first cumulative series per bucket from daily session/converting reports", async () => {
    const sessions = {
      rows: [r(["20260501", "original", "s1"]), r(["20260501", "original", "s2"]), r(["20260502", "original", "s3"]), r(["20260501", "about--a", "s4"]), r(["20260502", "about--a", "s5"])],
    };
    const converting = {
      rows: [r(["20260501", "original", "s1"]), r(["20260502", "about--a", "s5"])],
    };

...
import { LeadActionsTab } from "../../../../src/components/AnalyticsView/tabs/LeadActionsTab";
import leads from "../../../../__fixtures__/admin/leadActions.basic.json";
import journeys from "../../../../__fixtures__/admin/journeys.basic.json";

type AnyLeads = Parameters<typeof LeadActionsTab>[0]["leadActions"];
type AnyJourneys = Parameters<typeof LeadActionsTab>[0]["journeys"];

describe("LeadActionsTab", () => {
